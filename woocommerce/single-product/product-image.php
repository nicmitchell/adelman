...
$lightbox_rel = (get_option('woocommerce_enable_lightbox') == 'yes') ? 'prettyPhoto' : 'lightboxGall';
...
<div class="images <?php echo ($zoom == 'disable') ? 'zoom-disabled' : '';  ?>">
	...
	<?php if ( !$product->is_in_stock() ): ?>
		<?php $out_of_stock = '<span class="label-icon out-of-stock">'.__( 'Sold', ETHEME_DOMAIN ).'</span>'; ?>
					...
					<ul class="slides">
						...
						<li>
							<?php if ($lightbox_enabled && $zoom != 'disable'): ?>
								<a href="<?php echo $image_link; ?>" itemprop="image" class="zoom-link woocommerce-main-image zoom" rel="<?php echo $lightbox_rel; ?>">
									<i class="icon-resize-full"></i>
								</a>
							<?php endif ?>
							<?php if($zoom != 'disable' || $lightbox_enabled): ?><a href="<?php echo $image_link; ?>" class="main-image zoom" <?php if($zoom == 'disable' && $lightbox_enabled): ?>rel="<?php echo $lightbox_rel; ?>"<?php endif; ?> id="main-zoom-image"><?php endif; ?>
								<img src="<?php echo $image; ?>" title="<?php echo $image_title ?>">
							...
							<?php if ($attachment_ids): ?>
								<?php foreach ($attachment_ids as $key => $value): ?>
									<li>
										...
										<?php endif ?>
										<?php if($zoom != 'disable' || $lightbox_enabled): ?><a href="<?php echo etheme_get_image($value); ?>" <?php if($zoom == 'disable' && $lightbox_enabled): ?>rel="<?php echo $lightbox_rel; ?>"<?php endif; ?> class="main-image zoom"><?php endif ?>
